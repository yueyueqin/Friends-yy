...
public class FloatingActionButtonPlus extends ViewGroup {
    ...
    private void getAttributes(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.cyan.community.R.styleable.FloatingActionButtonPlus);
        mPosition = typedArray.getInt(com.cyan.community.R.styleable.FloatingActionButtonPlus_position, POS_RIGHT_BOTTOM);
        mAnimation = typedArray.getInt(com.cyan.community.R.styleable.FloatingActionButtonPlus_animationMode, ANIM_SCALE);
        mBackgroundColor = typedArray.getColor(com.cyan.community.R.styleable.FloatingActionButtonPlus_mBackgroundColor, 0xf2ffffff);
        mFabColor = typedArray.getColorStateList(com.cyan.community.R.styleable.FloatingActionButtonPlus_switchFabColor);
        mIcon = typedArray.getDrawable(com.cyan.community.R.styleable.FloatingActionButtonPlus_switchFabIcon);
        mAnimationDuration = typedArray.getInt(com.cyan.community.R.styleable.FloatingActionButtonPlus_animationDuration, 150);
