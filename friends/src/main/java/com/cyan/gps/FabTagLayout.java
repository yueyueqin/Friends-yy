...
public class FabTagLayout extends ViewGroup {
    ...
    private void getAttributes(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.cyan.community.R.styleable.FabTagLayout);
        mTagText = typedArray.getString(com.cyan.community.R.styleable.FabTagLayout_tagText);
        typedArray.recycle();
    }
